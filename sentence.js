...
const sentence = [
    ...
    new Sentence("למה יש פה דיבורים"),
    new Sentence("קרובי משפחה"),
    new Sentence("לא לא לא לא לא"),
    new Sentence("מה קורה שם?"),
    new Sentence("דיבורי צה\"ל"),
    new Sentence("אפשר להמשיך?"),
    new Sentence("כל אחד שיעשה מה שהוא רוצה")
];